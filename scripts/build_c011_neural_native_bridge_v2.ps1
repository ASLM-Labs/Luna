...
$BridgeSource = Join-Path $Repo "native\neural_bridge\c011_v2\luna_c011_nr2b_shim_harmony_v2.cpp"
...
$ObjectPath = Join-Path $BuildDir "luna_c011_nr2b_shim_harmony_v2.obj"
$BridgeDll = Join-Path $BuildDir "luna_c011_neural_bridge_v2.dll"
$BridgeLib = Join-Path $BuildDir "luna_c011_neural_bridge_v2.lib"
