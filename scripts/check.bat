...
echo [1/33] Package import ve syntax kontrolu...
...
echo [4/33] mypy strict...
"%PYTHON%" -m mypy src
if errorlevel 1 exit /b 13

echo [5/33] Faz 1 kontrat dogrulamasi...
"%PYTHON%" scripts\verify_phase1.py
if errorlevel 1 exit /b 14

echo [6/33] Faz 2 intent ve context dogrulamasi...
"%PYTHON%" scripts\verify_phase2.py
if errorlevel 1 exit /b 15

echo [7/33] Faz 3 planning ve replan dogrulamasi...
"%PYTHON%" scripts\verify_phase3.py
if errorlevel 1 exit /b 16

echo [8/33] Faz 4 model ve tool dogrulamasi...
"%PYTHON%" scripts\verify_phase4.py
if errorlevel 1 exit /b 17

echo [9/33] Faz 5 workspace, shell ve rollback dogrulamasi...
"%PYTHON%" scripts\verify_phase5.py
if errorlevel 1 exit /b 18

echo [10/33] Faz 6 observation, audit ve evidence dogrulamasi...
"%PYTHON%" scripts\verify_phase6.py
if errorlevel 1 exit /b 19

echo [11/33] Faz 7 verifier ve completion gate dogrulamasi...
"%PYTHON%" scripts\verify_phase7.py
if errorlevel 1 exit /b 20

echo [12/33] Faz 8 checkpoint ve continuity dogrulamasi...
"%PYTHON%" scripts\verify_phase8.py
if errorlevel 1 exit /b 21

echo [13/33] Faz 9 dogrulanmis hafiza dogrulamasi...
"%PYTHON%" scripts\verify_phase9.py
if errorlevel 1 exit /b 22

echo [14/33] Faz 10 kimlik, raporlama ve ozerklik dogrulamasi...
"%PYTHON%" scripts\verify_phase10.py
if errorlevel 1 exit /b 23

echo [15/33] Faz 11 eval ve kabul sinavi dogrulamasi...
"%PYTHON%" scripts\verify_phase11.py
if errorlevel 1 exit /b 24

echo [16/33] Faz 12A runtime kontrat dogrulamasi...
"%PYTHON%" scripts\verify_phase12a.py
if errorlevel 1 exit /b 25

echo [17/33] Faz 12B layered context composer dogrulamasi...
"%PYTHON%" scripts\verify_phase12b.py
if errorlevel 1 exit /b 26

echo [18/33] Faz 12C action selection dogrulamasi...
"%PYTHON%" scripts\verify_phase12c.py
if errorlevel 1 exit /b 27

echo [19/33] Faz 12D failure recovery ve isolation dogrulamasi...
"%PYTHON%" scripts\verify_phase12d.py
if errorlevel 1 exit /b 28

echo [20/33] Faz 12E single policy-agent loop dogrulamasi...
"%PYTHON%" scripts\verify_phase12e.py
if errorlevel 1 exit /b 29

echo [21/33] Faz 12F verification, evidence ve learning dogrulamasi...
"%PYTHON%" scripts\verify_phase12f.py
if errorlevel 1 exit /b 30

echo [22/33] Faz 12G runtime E2E ve behavior conformance dogrulamasi...
"%PYTHON%" scripts\verify_phase12g.py
if errorlevel 1 exit /b 31

echo [23/33] Faz 13 real-model compatibility ve controlled rollout dogrulamasi...
"%PYTHON%" scripts\verify_phase13.py
if errorlevel 1 exit /b 32

echo [24/33] Faz 14 research gateway ve evidence RAG dogrulamasi...
"%PYTHON%" scripts\verify_phase14.py
if errorlevel 1 exit /b 33

echo [25/33] Faz 15 resource manager, queue, scheduler ve notifications dogrulamasi...
"%PYTHON%" scripts\verify_phase15.py
if errorlevel 1 exit /b 34

echo [26/33] Faz 16 desktop product shell dogrulamasi...
"%PYTHON%" scripts\verify_phase16.py
if errorlevel 1 exit /b 35

echo [27/33] Faz 17 Discord gateway dogrulamasi...
"%PYTHON%" scripts\verify_phase17.py
if errorlevel 1 exit /b 36

echo [28/33] Faz 18 Voice Gateway dogrulamasi...
"%PYTHON%" scripts\verify_phase18.py
if errorlevel 1 exit /b 37

echo [29/33] Faz 19 trace/dataset governance ve cognitive quality foundation dogrulamasi...
"%PYTHON%" scripts\verify_phase19.py
if errorlevel 1 exit /b 38

echo [30/33] Faz 19B evaluation governance dogrulamasi...
"%PYTHON%" scripts\verify_phase19b.py
if errorlevel 1 exit /b 39

echo [31/33] Faz 19C learning integrity dogrulamasi...
"%PYTHON%" scripts\verify_phase19c.py
if errorlevel 1 exit /b 40

echo [32/33] Faz 19D controlled counterfactual analysis dogrulamasi...
"%PYTHON%" scripts\verify_phase19d.py
if errorlevel 1 exit /b 41

echo [33/33] CLI smoke...
...
echo.
echo [PASS] Luna 0.1 Phase 19D counterfactual analysis gate passed.
exit /b 0
