...
echo [1/38] Package import ve syntax kontrolu...
...
echo [4/38] mypy strict...
"%PYTHON%" -m mypy src
if errorlevel 1 exit /b 13

echo [5/38] Faz 1 kontrat dogrulamasi...
"%PYTHON%" scripts\verify_phase1.py
if errorlevel 1 exit /b 14

echo [6/38] Faz 2 intent ve context dogrulamasi...
"%PYTHON%" scripts\verify_phase2.py
if errorlevel 1 exit /b 15

echo [7/38] Faz 3 planning ve replan dogrulamasi...
"%PYTHON%" scripts\verify_phase3.py
if errorlevel 1 exit /b 16

echo [8/38] Faz 4 model ve tool dogrulamasi...
"%PYTHON%" scripts\verify_phase4.py
if errorlevel 1 exit /b 17

echo [9/38] Faz 5 workspace, shell ve rollback dogrulamasi...
"%PYTHON%" scripts\verify_phase5.py
if errorlevel 1 exit /b 18

echo [10/38] Faz 6 observation, audit ve evidence dogrulamasi...
"%PYTHON%" scripts\verify_phase6.py
if errorlevel 1 exit /b 19

echo [11/38] Faz 7 verifier ve completion gate dogrulamasi...
"%PYTHON%" scripts\verify_phase7.py
if errorlevel 1 exit /b 20

echo [12/38] Faz 8 checkpoint ve continuity dogrulamasi...
"%PYTHON%" scripts\verify_phase8.py
if errorlevel 1 exit /b 21

echo [13/38] Faz 9 dogrulanmis hafiza dogrulamasi...
"%PYTHON%" scripts\verify_phase9.py
if errorlevel 1 exit /b 22

echo [14/38] Faz 10 kimlik, raporlama ve ozerklik dogrulamasi...
"%PYTHON%" scripts\verify_phase10.py
if errorlevel 1 exit /b 23

echo [15/38] Faz 11 eval ve kabul sinavi dogrulamasi...
"%PYTHON%" scripts\verify_phase11.py
if errorlevel 1 exit /b 24

echo [16/38] Faz 12A runtime kontrat dogrulamasi...
"%PYTHON%" scripts\verify_phase12a.py
if errorlevel 1 exit /b 25

echo [17/38] Faz 12B layered context composer dogrulamasi...
"%PYTHON%" scripts\verify_phase12b.py
if errorlevel 1 exit /b 26

echo [18/38] Faz 12C action selection dogrulamasi...
"%PYTHON%" scripts\verify_phase12c.py
if errorlevel 1 exit /b 27

echo [19/38] Faz 12D failure recovery ve isolation dogrulamasi...
"%PYTHON%" scripts\verify_phase12d.py
if errorlevel 1 exit /b 28

echo [20/38] Faz 12E single policy-agent loop dogrulamasi...
"%PYTHON%" scripts\verify_phase12e.py
if errorlevel 1 exit /b 29

echo [21/38] Faz 12F verification, evidence ve learning dogrulamasi...
"%PYTHON%" scripts\verify_phase12f.py
if errorlevel 1 exit /b 30

echo [22/38] Faz 12G runtime E2E ve behavior conformance dogrulamasi...
"%PYTHON%" scripts\verify_phase12g.py
if errorlevel 1 exit /b 31

echo [23/38] Faz 13 real-model compatibility ve controlled rollout dogrulamasi...
"%PYTHON%" scripts\verify_phase13.py
if errorlevel 1 exit /b 32

echo [24/38] Faz 14 research gateway ve evidence RAG dogrulamasi...
"%PYTHON%" scripts\verify_phase14.py
if errorlevel 1 exit /b 33

echo [25/38] Faz 15 resource manager, queue, scheduler ve notifications dogrulamasi...
"%PYTHON%" scripts\verify_phase15.py
if errorlevel 1 exit /b 34

echo [26/38] Faz 16 desktop product shell dogrulamasi...
"%PYTHON%" scripts\verify_phase16.py
if errorlevel 1 exit /b 35

echo [27/38] Faz 17 Discord gateway dogrulamasi...
"%PYTHON%" scripts\verify_phase17.py
if errorlevel 1 exit /b 36

echo [28/38] Faz 18 Voice Gateway dogrulamasi...
"%PYTHON%" scripts\verify_phase18.py
if errorlevel 1 exit /b 37

echo [29/38] Faz 19 trace/dataset governance ve cognitive quality foundation dogrulamasi...
"%PYTHON%" scripts\verify_phase19.py
if errorlevel 1 exit /b 38

echo [30/38] Faz 19B evaluation governance dogrulamasi...
"%PYTHON%" scripts\verify_phase19b.py
if errorlevel 1 exit /b 39

echo [31/38] Faz 19C learning integrity dogrulamasi...
"%PYTHON%" scripts\verify_phase19c.py
if errorlevel 1 exit /b 40

echo [32/38] Faz 19D controlled counterfactual analysis dogrulamasi...
"%PYTHON%" scripts\verify_phase19d.py
if errorlevel 1 exit /b 41

echo [33/38] Faz 19E small controlled SFT governance dogrulamasi...
"%PYTHON%" scripts\verify_phase19e.py
if errorlevel 1 exit /b 42

echo [34/38] Faz 19F improvement gate dogrulamasi...
"%PYTHON%" scripts\verify_phase19f.py
if errorlevel 1 exit /b 43

echo [35/38] C-002 capability lineage dogrulamasi...
"%PYTHON%" scripts\verify_c002.py
if errorlevel 1 exit /b 44

echo [36/38] C-001 adaptive knowledge retrieval dogrulamasi...
"%PYTHON%" scripts\verify_c001.py
if errorlevel 1 exit /b 45

echo [37/38] C-003 experience distillation dogrulamasi...
"%PYTHON%" scripts\verify_c003.py
if errorlevel 1 exit /b 46

echo [38/38] CLI smoke...
...
echo.
echo [PASS] Luna 0.1 Phase 19F + C-002 lineage + C-001 retrieval + C-003 distillation gate passed.
exit /b 0
