...
- Added deterministic source-family routing for internal/context/memory/RAG/research/API knowledge.
- Added freshness/citation requirements for external retrieval routes.
- Added contradiction STOP/reinspect and private user-specific no-public-fallback boundaries.
- Added C-001 verifier, CLI smoke, capability-lineage metadata, and documentation.
